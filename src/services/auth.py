...
class PasswordManager:
    ...
    def get_new_password(self, password_length: int = 12, meeting_limit: int = 3) -> str:
        """
        ...
        while True:
            ...
            if any(char in special_chars for char in pwd) and sum(char in digits for char in pwd) >= meeting_limit:
                break
